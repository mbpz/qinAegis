...
async function buildFixtureContext() {
    const shotSize = await (0, img_namespaceObject.imageInfoOfBase64)(CONNECTIVITY_FIXTURE_IMAGE);
    return {
        screenshot: external_screenshot_item_js_namespaceObject.ScreenshotItem.create(CONNECTIVITY_FIXTURE_IMAGE, Date.now()),
        shotSize,
