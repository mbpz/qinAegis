...
async function executeAction(activeAgent, actionType, actionSpace, value, options) {
    if ('aiAct' !== actionType && void 0 !== options.deepThink) console.warn('[Playground] Received deepThink in non-aiAct action options. deepThink is expected to be used with aiAct during migration.', {
        actionType,
